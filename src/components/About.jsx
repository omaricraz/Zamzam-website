...
const About = () => {
  return (
    <section id="about" className="py-12 md:py-24 bg-white dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="grid lg:grid-cols-2 gap-8 md:gap-16 items-center">
          <div>
            ...
            <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-brand-blue dark:text-brand-green mb-4 md:mb-6 leading-tight">
              ZamZam Food Industry
            </h3>
            <p className="text-base sm:text-lg md:text-base text-gray-600 dark:text-gray-300 mb-4 md:mb-6 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-3 md:gap-4">
              <div className="flex items-center gap-2 md:gap-3 px-3 md:px-4 py-2 bg-blue-50 dark:bg-brand-green/10 rounded-lg">
                <i className="fas fa-industry w-4 md:w-5 h-4 md:h-5 text-brand-blue dark:text-brand-green"></i>
                <span className="text-sm md:text-base font-semibold text-brand-blue dark:text-brand-green">Established 2003</span>
              </div>
              <div className="flex items-center gap-2 md:gap-3 px-3 md:px-4 py-2 bg-green-50 dark:bg-brand-green/10 rounded-lg">
                <i className="fas fa-map-marker-alt w-4 md:w-5 h-4 md:h-5 text-green-600 dark:text-brand-green"></i>
                <span className="text-sm md:text-base font-semibold text-brand-blue dark:text-brand-green">Hargeisa, Somaliland</span>
              </div>
            </div>
          </div>
          <div className="relative mt-8 lg:mt-0">
            <div className="absolute -inset-2 md:-inset-4 bg-gradient-to-br from-brand-blue/20 dark:from-brand-green/20 to-brand-red/20 rounded-2xl md:rounded-3xl transform rotate-3"></div>
            <img
