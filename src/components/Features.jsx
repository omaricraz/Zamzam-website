...
const Features = () => {
  return (
    <section id="features" className="py-12 md:py-24 bg-brand-light">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl p-6 md:p-10 shadow-lg mb-6 md:mb-8">
            <h3 className="text-xl md:text-2xl font-bold text-brand-blue mb-4">Vision</h3>
          ...
          <div className="bg-white rounded-2xl p-6 md:p-10 shadow-lg">
            <h3 className="text-xl md:text-2xl font-bold text-brand-blue mb-4">Mission</h3>
            <p className="text-gray-600 leading-relaxed text-base md:text-lg">
